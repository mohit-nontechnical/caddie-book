      ...
      {!loading && !error && (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {courses.map((c) => {
            ...
            return (
              <div key={c.norm} className="sc-tile" style={{ background: "var(--panel)", border: "1px solid var(--line)", borderRadius: 18, overflow: "hidden", cursor: "pointer" }}>
                ...
                <div style={{ height: 110, background: "linear-gradient(160deg, #1B4D3E 0%, #0F2D1A 60%, #0A1A0E)", position: "relative", overflow: "hidden" }}>
                  ...
                  <div style={{ position: "absolute", top: 10, left: 14, fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.12em", color: "rgba(255,255,255,0.6)" }}>
